...
steps.  Thus, pending the elementary QM57--QM59 Lean consumer, every ordinary
core in the box is at least `2^4096`.  The largest leading-zero run was only
16 bits, so the scan found no stabilization anomaly worth promoting.
